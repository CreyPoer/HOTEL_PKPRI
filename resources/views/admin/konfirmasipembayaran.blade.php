    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <h3 class="card-title">Pemesanan Menunggu Konfirmasi</h3><br>
                                ...
                                <div class="mb-3 pt-2">
                                    ...
                                    <div class="collapse" id="collapseExample">
                                        <div class="card card-body">
                                            <img src="{{ asset('images/bahan1.jpeg') }}" alt="" >
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="row">
                                <div class="card col-auto">
                                    ...
                                    <div class="card-body bg-tan text-center   ">
                                        <h3 class="card-title text-center" style="color:black;background:tan;width:100%;"><b>{{ $pemesananDanPembayaran->kamar['jenis_kamar'] }}</b></h3>
                                    ...
                                    <div class="accordion-item" >
                                        ...
                                        <button style="background-color:tan;width:100%;color:black;margin-left:-0.15rem;border:3px solid black;" class="accordion-button-color collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" collapsed>
                                            <b>Fasilitas</b>
                                        </button>
                                    </h5>
                                    @foreach($dtKamar as $data)
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body" style="background-color:black;color:tan;">
                                        <div class="macamfasilitas">
                                            <div class="fasilitas row">
                                                    <div class="col" style="text-align: start;width:11.5rem;"><h6>Kapasitas </h6></div>
                                                    <div class="col-md-7" style="text-align: start;padding-left:0.5rem;width:18rem;"><h6>: {{ $data['kamar']->kapasitas }} Orang</h6></div>
                                            </div>
                                            <div class="fasilitas row">
                                                    <div class="col" style="text-align: start;width:11.5rem;"><h6>Bed</h6></div>
                                                    <div class="col-md-7" style="text-align: start;padding-left:0.5rem;width:18rem;"><h6>: {{ $data['kamar']->bed }}</h6></div>
                                            </div>
                                            <div class="fasilitas row">
                                                    <div class="col" style="text-align: start;width:11.5rem;"><h6>Pendingin </h6></div>
                                                    <div class="col-md-7" style="text-align: start;padding-left:0.5rem;width:18rem;"><h6>: {{ $data['kamar']->pendingin_ruangan }}</h6></div>
                                            </div>
                                            <div class="fasilitas row">
                                                    <div class="col" style="text-align: start;width:11.5rem;"><h6>Televisi </h6></div>
                                                    <div class="col-md-7" style="text-align: start;padding-left:0.5rem;width:18rem;"><h6>: {{ $data['kamar']->tv }}</h6></div>
                                            </div>
                                            <div class="fasilitas row">
                                                    <div class="col" style="text-align: start;width:11.5rem;"><h6>Kamar Mandi </h6></div>
                                                    <div class="col-md-7" style="text-align: start;padding-left:0.5rem;width:18rem;"><h6>: {{ $data['kamar']->kamar_mandi }}</h6></div>
                                            </div>
                                            <div class="fasilitas row">
                                                    <div class="col" style="text-align: start;width:11.5rem;"><h6>Peralatan Mandi </h6></div>
                                                    <div class="col-md-7" style="text-align: start;padding-left:0.5rem;width:18rem;"><h6>: {{ $data['kamar']->peralatan_mandi }}</h6></div>
                                            </div>
                                            <div class="fasilitas row">
                                                    <div class="col" style="text-align: start;width:11.5rem;"><h6>Breakfast </h6></div>
                                                    <div class="col-md-7" style="text-align: start;padding-left:0.5rem;width:18rem;"><h6>: {{ $data['kamar']->breakfast }}</h6></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
